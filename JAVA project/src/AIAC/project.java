...
public class project {
	...
	/*	
		...
		System.out.println("enter le nom de l'école");
		String nomEcole=sc.nextLine();
		System.out.println("enter l'abreveation de l'école");
		String abrEcole=sc.nextLine();
		System.out.println("enter le fondateur de l'école");
		String fondateur=sc.nextLine();
		System.out.println("enter le type de l'école");
		String type=sc.nextLine();
		System.out.println("enter l'adresse de l'école");
	 ...
	 /*	
	 	 while (id==0) {
	 		System.out.println("vous étes:"+Newligne+Newligne+"1-Administrateur"+Newligne+"2-Responsable de filière"+Newligne+"3-Enseignant"+Newligne+"4-Etudiant"+Newligne+"5-Visiteur");
		 	id=sc.nextInt();
		 	sc.nextLine();
		 	System.out.println(Newligne);
			System.out.println("Entrez votre Nom ");
			String nom =sc.nextLine();
			System.out.println("Entrez votre et Prénom");
	...
	//************************** ADMINISTRATEUR ****************************************		
			if(id==1) {
				...
				if (pwd.equals("admin")) {
					...
					int ad1=0;
					while (ad1==0) {
						System.out.println("Choisir votre prochaine action:"+Newligne+Newligne+"1-Géstion des études"+Newligne+"2-Géstion de scolarité"+Newligne+"3-Les statistiques et rapports "+Newligne+"4-Retour"+Newligne);
						ad1=sc.nextInt();
						sc.nextLine();
						if (ad1==1) {//gestion des etudes 
							int ad2=0;
							while (ad2==0) {
								System.out.println("Choisir votre prochaine action:"+Newligne+Newligne+"1-Créer une filière"+Newligne+"2-Créer une classe"+Newligne+"3-ajout d'un responsable de filière "+Newligne+"4-Retour");
								 ad2= sc.nextInt();
								 sc.nextLine();
								if (ad2==1) {
									System.out.println("Veuillez saisir le nom de la nouvelle filière");
		...
		*/							
		/*						if (ad2==2) {
									System.out.println("Veuillez Saisir la filière dans laquel vous voulez ajouter la promotion");
			...
			/*						
									...
									sc.nextLine();
									Promo promotion=new Promo(ecole.choisirFiliere(filierechoisie),année);
								...
								if (ad2==3) {
									...
									System.out.println("Affectez le responsable à une filière:");
									ecole.affichefiliereEcole();
									int filierechoisie=sc.nextInt();
									sc.nextLine();
									Filiere filiere=ecole.choisirFiliere(filierechoisie);
					...
					*/			 
									/*	if (ad2==4)
								{
									System.out.println("Veuillez choisir la filière");
									ecole.affichefiliereEcole();
									int filierechoisie=sc.nextInt();
									sc.nextLine();
									int i=1;
	...
	/*						
					...
					if(ad1==3) {//les statistiq
						while (ad1==0){
						System.out.println("Choisir votre prochaine action:"+Newligne+Newligne+"1-Statistiques et rapport sur les études"+Newligne+"2-Statistiques et rapport sur la scolarité"+Newligne+"3-Statistiques et rapport sur les exams "+Newligne+"4-Retour"+Newligne);
						ad1=sc.nextInt();
						sc.nextLine();
						if (ad1==1){//etude
						int ad2=0;
						while(ad2==0){
							System.out.println("Choisir votre prochaine action:"+Newligne+Newligne+"1-Afficher les filières de l'école"+Newligne+"2-Afficher les classes d'une filière"+Newligne+"3-Afficher les heures des modules pour chaque fillière"+Newligne+"4-Afficher les emploies du temps "+Newligne+"5-Retour"+Newligne);
							ad2=sc.nextInt();
							sc.nextLine();
	...
	//****************************	RESPONSABLE DE FILIERE **************************	
			 ...
			 if(id==2){
				System.out.println("Veuillez saisir votre filière");
				ecole.affichefiliereEcole();
				int filierechoisie=sc.nextInt();
				sc.nextLine();
				Filiere filiere=ecole.choisirFiliere(filierechoisie);
				...
				if(respo.exist(ecole.respoEcole)) {
					...
					if (pwd.equals("")) {	
						int r=0;
						while (r==0) {
							System.out.println("Choisir votre prochaine action:"+Newligne+Newligne+"1-Géstion des études"+Newligne+"2-Géstion de scolarité"+Newligne+"3-Gestion des exams "+Newligne+"4-Retour"+Newligne);
							r=sc.nextInt();
							sc.nextLine();
							if (r==1) {//gestion des etudes
								int r1=0;
								while (r1==0) {
									System.out.println("Choisir votre prochaine action:"+Newligne+Newligne+"1-Ajout des modules pour une classe"+Newligne+"2-ajout d'element"+Newligne+"3-Retirer un module"+Newligne+"4-Retirer un élément"+Newligne+"5-Determination des enseignants"+Newligne+"6-Gestion d'emploi"+Newligne+"7-Afficher les données de la filière"+Newligne+"8-Retour");
									r1=sc.nextInt();
									sc.nextLine();
									...
									if (r1==5) {//prof
										...
										System.out.println("entrer le prénom d'enseignant");
									...
									int r2=0;
									while(r2==0) {
										System.out.println("choisir votre prochaine action:"+Newligne+"1-afficher les classes de la filière"+filiere.nomFilière+Newligne+"2-afficher les étudiants de la filière"+filiere.nomFilière+Newligne+"3-afficher les profs de la filière"+filiere.nomFilière+Newligne+"4-afficher les emploies d'une classe"+filiere.nomFilière+Newligne+"5-afficher les modules d'une classes"+filiere.nomFilière+Newligne+"6-afficher les element d'un module"+filiere.nomFilière+Newligne+"7-Retour"+Newligne);										
										r2=sc.nextInt();
										sc.nextLine();
										if (r2==1) {//classe
					...
					System.out.println("vous n'étes pas un responsable dans cette ecole");
					id=0;
					}
