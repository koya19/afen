...
public class Project {
	...
	public static void main(String[] args) throws ParseException   {
		...
		System.out.println("\n--Veuillez entrer vos données personelles");
		ecole.inscription();
		ecole.addfilière();
		ecole.addclass();
...
//---------------------------------ADMIN------------------------------------------------------	 	
			if(id==1) {//connection admin
				...
				if (admin.exist(ecole.adminEcole)==false) {//check l'existence de l'admin
					System.out.println("\nVous n'étes pas membre de l'administration\n");
					id=0;
			...
			if(id==4) {//connection etudiant
				...
				if(ecole.studEcole.isEmpty()) {//ecole vide
					...
					s1=0;
						...
						System.out.println("Vous n'étes pas un étudiant dans cette école :\n 1) S'inscrire\n 2) Quitter");
						try {
