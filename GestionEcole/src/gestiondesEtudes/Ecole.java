	...
	public void removeClass() {
		...
		public void removeAdmin(){
			...
			if (this.adminEcole.isEmpty()) {
				System.out.println("Pas dadministrateur à retirer");
			}
			else {
